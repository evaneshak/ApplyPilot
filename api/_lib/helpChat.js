...
- Dashboard: shows application totals, stage counts, response rate, urgent deadlines, filters, search, sorting, and a five-stage board.
- Log Application: the user pastes a job posting; AI extracts company, role, work location, salary, deadline, and up to eight skills. The user reviews and edits the draft before saving it. New applications start in Saved.
...
- Resume: users can paste plain text or import a text-based PDF, then save it. Scanned/image-only PDFs may not contain extractable text.
...
- Logout: use Log out in the top navigation.
